module.exports = {
  ...
  Presence: {
    ...
    name: process.env.Presence_Name || "Sound", // The message shown
  ...
  Lavalink: {
    ...
    host: process.env.Lavalink_Host || "lava.link", //- The host name or IP of the lavalink server.
    port: parseInt(process.env.Lavalink_Port || "80"), // The port that lavalink is listening to. This must be a number!
    pass: process.env.Lavalink_Pass || "youshallnotpass", //- The password of the lavalink server.
    secure: process.env.Lavalink_Secure === "true" || false, // Set this to true if the lavalink uses SSL. if not set it to false.
